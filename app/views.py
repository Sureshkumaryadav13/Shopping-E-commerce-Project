...
class ProductView(View):
    def get(self, request):
        ...
        return render(request, 'app/home.html', {'bottomwears':bottomwears, 'topwears':topwears, 'mobiles':mobiles})


# def product_detail(request):
#  return render(request, 'app/productdetail.html')

class ProdeuctDetailView(View):
...
def Bottomwear(request, data=None):
    if data == None:
        bottomwears = Product.objects.filter(category='Bw')
    elif data == 'Lee' or data == 'Spark':
        bottomwears = Product.objects.filter(category='Bw').filter(brand=data)
        print('Botomwears',bottomwears)
    elif data == 'below':
...
class ProfileView(View):
    ...
    def post(self, reqeust):
        form = CustomerProfileForm(reqeust.POST)
        if form.is_valid():
            user = reqeust.user
        ...
        return render(reqeust, 'app/profile.html', {'form':form, 'active':'btn-primary'})
